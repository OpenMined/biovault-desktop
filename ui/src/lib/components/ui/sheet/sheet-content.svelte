<script lang="ts" module>
	...
	export const sheetVariants = tv({
		base: "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-300 data-[state=closed]:duration-220 data-[state=open]:ease-out data-[state=closed]:ease-in fixed z-50 flex flex-col gap-4 shadow-lg will-change-transform",
		variants: {
			side: {
