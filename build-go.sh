...
if [[ "$(uname)" == "Darwin" ]]; then
  ...
  find src-tauri/resources/bundled src-tauri/resources/syftbox src-tauri/resources/syqure -type f \( -perm +111 -o -name "*.dylib" -o -name "*.jnilib" \) -print0 2>/dev/null | while IFS= read -r -d '' f; do
